...
public class Main extends Application implements Initializable {
    ...
    /*public ObservableList<StudentEntity> convertListToObservableList(List<StudentEntity> studentEntityList) {
        ObservableList<StudentEntity> observableList = FXCollections.observableArrayList();
    ...
    public void createStudent(){
        ...
        clearTextBoxes();
        //studentTableView.getItems().add(studentEntity);
        loadStudentList();
